...
def generate_search_index(
    ...
    # Heartbeat cadence: this loop reads every app's year files off disk and
    # is the single longest stretch of finalize (many minutes for ~47k apps).
    # Without a periodic line it reads as a hang on the CI UI -- same
    # rationale as the app-index PROGRESS_EVERY heartbeat.
    PROGRESS_EVERY = 5000
