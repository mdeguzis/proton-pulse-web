...
REQUIRED_SECRETS = [
    ...
    ("PCGAMINGWIKI_BOT_USER", "pcgamingwiki.com Special:BotPasswords (owner SSO account, Basic rights only)"),
    ("PCGAMINGWIKI_BOT_PASS", "pcgamingwiki.com Special:BotPasswords (generated token)"),
