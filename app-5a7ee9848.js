  ...
  return `
    ...
    <div class="card-summary">
      ...
      <div class="details-btn-row">
        ...
        ${(() => { const fr = buildFormRows(r); return fr ? `<button class="all-details-btn" onclick="const p=this.closest('.card-summary').querySelector('.fr-panel');p.classList.toggle('open');this.textContent=p.classList.contains('open')?'Hide Q&amp;A Responses':'Show Q&amp;A Responses'">Show Q&amp;A Responses</button>` : ''; })()}
      </div>
