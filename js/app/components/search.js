...
import { renderGamePage } from './game-page.js?v=d00f87c3';
import { STEAM_IMG, SITE_ROOT, USES_PROD_DATA, storeLabelFromAppId, fetchDataWithProdFallback } from '../config.js?v=593229c5';
