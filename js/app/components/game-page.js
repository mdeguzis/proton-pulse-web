...
import { enhanceAuthorBlocks } from './author.js?v=ba20a0b5';
...
import { renderCard } from './report-card.js?v=aafaa049';
import { loadSearchIndex, searchIndex } from './search.js?v=47b70b69';
