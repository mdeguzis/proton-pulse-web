...
import { enhanceAuthorBlocks } from './author.js?v=5db19141';
...
import { renderCard } from './report-card.js?v=fd4e53d3';
import { loadSearchIndex, searchIndex } from './search.js?v=fb69ca86';
