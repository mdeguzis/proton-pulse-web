...
import { _protonDbLiveCache, fetchCdn, fetchProtonDbLive } from '../api/protondb.js?v=630d1b3c';
...
import { enhanceAuthorBlocks } from './author.js?v=6d3a0b19';
...
import { renderCard } from './report-card.js?v=8371f771';
