...
import { enhanceAuthorBlocks } from './author.js?v=74f1dbf6';
...
import { renderCard } from './report-card.js?v=02b03edc';
import { loadSearchIndex, searchIndex } from './search.js?v=797fbff8';
