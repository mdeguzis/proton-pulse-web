...
import { enhanceAuthorBlocks } from './author.js?v=d0d60ced';
...
import { renderCard } from './report-card.js?v=f5ce1df4';
import { loadSearchIndex, searchIndex } from './search.js?v=c7258acf';
