...
import { enhanceAuthorBlocks } from './author.js?v=9e36fe0e';
...
import { renderCard } from './report-card.js?v=6b9274ee';
import { loadSearchIndex, searchIndex } from './search.js?v=02d75300';
