...
import { enhanceAuthorBlocks } from './author.js?v=9f5d04d2';
...
import { renderCard } from './report-card.js?v=00bb115d';
import { loadSearchIndex, searchIndex } from './search.js?v=7cfa46be';
