...
import { renderGamePage } from './components/game-page.js?v=944fe77f';
import { renderHomePage } from './components/home.js?v=306eafc9';
import { renderSearchPage } from './components/search.js?v=0f61dcdb';
