...
import { renderGamePage } from './components/game-page.js?v=3eee752f';
import { renderHomePage } from './components/home.js?v=6132ed5d';
import { renderSearchPage } from './components/search.js?v=3b08f36f';
