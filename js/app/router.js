...
import { renderGamePage } from './components/game-page.js?v=01a0b4dc';
import { renderHomePage } from './components/home.js?v=3122433d';
import { renderSearchPage } from './components/search.js?v=1c506cce';
