...
import { renderGamePage } from './components/game-page.js?v=68acb6a0';
import { renderHomePage } from './components/home.js?v=38d1be34';
import { renderSearchPage } from './components/search.js?v=a7e41fb5';
