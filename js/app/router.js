...
import { renderGamePage } from './components/game-page.js?v=29bd6a7f';
import { renderHomePage } from './components/home.js?v=61d9702a';
import { renderSearchPage } from './components/search.js?v=48137be4';
