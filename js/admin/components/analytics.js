...
export function renderAnalytics(data, { daysBack, onChangeDays }) {
  ...
  content.innerHTML = `
    ...
    <p class="chart-caption">Pulse Reports landed per day, stacked by source. Web = browser submissions (source starts with "web-"). Plugin = Steam Deck plugin (source is "user", "protondb", "protondb-local", or starts with "plugin"). Other = anything else.</p>
