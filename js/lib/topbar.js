  ...
  <div class="topbar-nav">
    <nav class="topnav-links" id="primary-nav">
      ...
      <div class="nav-dropdown" data-group="resources">
        ...
        <div class="nav-dropdown-panel">
          <a href="https://github.com/mdeguzis/proton-pulse-web/releases" target="_blank" rel="noopener" title="What's new: release notes with screenshots on GitHub">
...
<div class="mobile-nav-drawer" id="mobile-nav-drawer" hidden>
  ...
  <div class="mnav-group">
    ...
    <div class="mnav-sub">
      <a href="https://github.com/mdeguzis/proton-pulse-web/releases" target="_blank" rel="noopener"><svg class="nav-icon" aria-hidden="true"><use href="#icon-info"/></svg> What's New</a>
